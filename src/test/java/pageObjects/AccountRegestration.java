...
//constructor
  ...
  //  @FindBy(xpath = "//label[normalize-space()='No']") WebElement chksubscElement;
    
    @FindBy(xpath = "//input[@name='agree']") WebElement chkprivacy;
  
    @FindBy(xpath="//input[@value='Continue']") WebElement btnContinue;
   
   @FindBy(xpath = "//h1[normalize-space()='Your Account Has Been Created!']") WebElement   msgconfirmations;
